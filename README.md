...
| <a name="input_module_context"></a> [module\_context](#input\_module\_context) | Infix for the SSM parameter name. If provided, must end with '/' and may only contain alphanumeric characters, '-', '\_' and '/'. | `string` | `""` | no |
...
[module-version-shield]: https://img.shields.io/badge/module_version-1.6.2-CB224B?style=flat
...
[release-url]: https://registry.terraform.io/modules/acai-solutions/lambda/aws/latest
[license-url]: ./LICENSE
